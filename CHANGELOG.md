...
-   Added a button on the top right toolbar to toggle the user list visiblity. This is useful if the chat is in portrait mode
-   Integrated RPH Log Manager into this release

##### Bug Fixes

-   Fixed an issue where chat message colorizing wasn't working
